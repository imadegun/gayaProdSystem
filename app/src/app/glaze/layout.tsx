...
const navigation = [
  ...
  { name: "Work Plans", href: "/glaze/work-plans", icon: Palette, roles: ["Glaze", "Admin"] },
  { name: "Daily Recap", href: "/glaze/recap", icon: Clock, roles: ["Glaze", "Admin"] },
  { name: "Production", href: "/glaze/production", icon: Package, roles: ["Glaze", "Admin"] },
  { name: "Quality", href: "/glaze/quality", icon: CheckCircle, roles: ["Glaze", "Admin"] },
  { name: "Issues", href: "/glaze/issues", icon: AlertTriangle, roles: ["Glaze", "Admin"] },
  { name: "Settings", href: "/glaze/settings", icon: Settings, roles: ["Glaze", "Admin"] },
];
...
export default function GlazeLayout({
  ...
  useEffect(() => {
    ...
    if (session && session.user.role !== "Glaze" && session.user.role !== "Admin") {
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-purple-500">
            ...
            <Button
              ...
              className="w-full mt-3 justify-start text-white hover:bg-purple-700"
            >
